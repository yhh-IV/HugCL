...
import numpy as np
from helpers.properties import calc_delta_v
...
def get_protected_log_reg_harm(ego_vehicle, obstacle, pdof: float, ego_angle: float,
                               obs_angle: float, modes, coeffs):
    ...
    ego_delta_v, obstacle_delta_v = calc_delta_v(vehicle_1=ego_vehicle, vehicle_2=obstacle, pdof=pdof)
