...
from srunner.autoagents.agents.navigation.basic_agent import BasicAgent
from srunner.autoagents.agents.navigation.constant_velocity_agent import ConstantVelocityAgent
from srunner.autoagents.agents.navigation.local_planner import RoadOption, LocalPlanner
from srunner.autoagents.agents.utils.misc import is_within_distance, get_speed
...
from srunner.autoagents.agents.navigation.global_route_planner import GlobalRoutePlanner
...
class LaneChange(WaypointFollower):
    ...
    def __init__(self, actor, speed=6, direction='left', distance_same_lane=1, distance_other_lane=100,
...
class ActorFlow(AtomicBehavior):
    ...
    def _spawn_actor(self, transform):
        ...
        self._tm.set_desired_speed(actor, self._speed*3.6)
...
class InvadingActorFlow(AtomicBehavior):
    ...
    def __init__(self, source_wp, sink_wp, reference_actor, spawn_dist,
        ...
        # Opposite direction needs earlier vehicle detection
        self._opt_dict = {'base_vehicle_threshold': 5, 'detection_speed_ratio': 2, 'distance_ratio': 0.2}
